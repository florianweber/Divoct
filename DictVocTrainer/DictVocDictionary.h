...
typedef void (^db_init_block_t) (NSError *error);
typedef void (^db_query_wordsArray_completion_block_t) (NSString *seachTerm, NSArray *sqliteResults);
typedef void (^db_query_word_completion_block_t) (SQLiteWord *word);

@interface DictVocDictionary : NSObject
