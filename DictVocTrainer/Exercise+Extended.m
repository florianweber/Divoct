...
-(NSNumber *)successRate
{
    ...
    } else if ((self.countCorrect.intValue - self.countWrong.intValue) >= [DictVocSettings instance].trainingPerfectSuccessRate) {
        successRate = [NSNumber numberWithFloat:2.0];
    } else {
